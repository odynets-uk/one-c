...
- Продуктивність COM-витягу цін/залишків (281 с на 8 товарів) — винесено в окрему під-задачу `task-004a-performance`.
...
| 2026-08-09 | Задача закрита. Проблема продуктивності винесена в окрему під-задачу `task-004a-performance` (гілка `task-004a-performance`) | done |
