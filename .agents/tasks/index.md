...
| `task-004b-changed-since` | Оптимізація витягу змінених товарів (changed_since) | `in-progress` | `task-004a-performance` | 2d |
| `task-005-sync-sqlite` | Синхронізатор та SQLite | `backlog` | `task-004b-changed-since` | 5d |
